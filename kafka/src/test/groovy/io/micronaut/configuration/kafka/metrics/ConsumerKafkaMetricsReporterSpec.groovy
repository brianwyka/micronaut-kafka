...
class ConsumerKafkaMetricsReporterSpec extends Specification {
    ...
    def setupSpec() {
        ...
        embeddedServer = ApplicationContext.run(EmbeddedServer,
                CollectionUtils.mapOf(
                        ...
                        AbstractKafkaConfiguration.EMBEDDED_TOPICS, ["bicycles"]
                )
        )
    ...
    void "test simple consumer"() {
        ...
        context.containsBean(BicycleListener)
    ...
    static class BicycleListener {
        ...
        @Topic("bicycles")
        void collectBicycles(String bike, @Header String topic) {
            bicycles.add(bike)
            lastTopic = topic
        }
    }
